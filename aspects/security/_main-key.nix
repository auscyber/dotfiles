...
#
# Plain data, `_`-prefixed so the import tree skips it (same reason as
# ../hosts/_registry.nix): ./main-ssh-key.nix wires it into hosts, and
# ../nixos/iso.nix needs it outside any host scope.
