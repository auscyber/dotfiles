...
{ config, lib, pkgs, ... }: {
  ...
  networking.interfaces.enp2s0.eth0.ipv4.addresses= [{
	address = "192.168.1.26";
	prefixLength = 24;
  }];
  networking.defaultGateway = "192.168.1.1";
  networking.namesevers = ["192.168.1.26"];
  # Open ports in the firewall.
  networking.firewall.allowedTCPPorts = [ 25565 8080 21115 21118 21119 21116 21117 80 53 443 1080];
  networking.firewall.allowedUDPPorts = [ 51820 21116 53 67 ];
