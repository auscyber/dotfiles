...
(local base {:color_schemes {"Pink Ocean" (require :pink_ocean)}
             :front_end :WebGpu
             ...
             :font (?windows (wezterm.font "FiraCode NF")
                             (wezterm.font_with_fallback ["Hasklug Nerd Font Mono"
                                                          :codicon]))
             :font_size 15
